...
**Authentication** is handled by **Firebase Authentication**, and **payments** are processed via **Stripe**.
...
### Schema Overview
- **CUSTOMERS:** Stores customer information (linked with Firebase Auth).
